...
class FormWTFAjouterGenres(FlaskForm):
    ...
    email_wtf = StringField("Clavioter le numero de votre facture ",
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    """
    email_regexp = "^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$"
    email_update_wtf = StringField("Clavioter le motif de la facture ",
                                      validators=[Length(min=2, max=80, message="min 2 max 20"),
                                                  Regexp(email_regexp,
                                                         message="pas d'espace")
                                                  ])
...
class FormWTFDeleteGenre(FlaskForm):
    ...
    """
    email_delete_wtf = StringField("Effacer cet utilisateur")
