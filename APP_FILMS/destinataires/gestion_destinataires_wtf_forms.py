...
class FormWTFUpdateGenre(FlaskForm):
    """
        Dans le formulaire "destinataires_update_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """
    destinataire_regexp = "^[A-Za-z0-9 ]*[A-Za-z0-9][A-Za-z0-9 ]*$"
    destinataires_update_wtf = StringField("Clavioter le destinataire de la facture ",
                                      validators=[Length(min=2, max=80, message="min 2 max 20"),
                                                  Regexp(destinataire_regexp,
                                                         message="pas d'espace")
                                                  ])
...
class FormWTFDeleteGenre(FlaskForm):
    """
        Dans le formulaire "destinataires_delete_wtf.html"
    ...
    """
    destinataires_delete_wtf = StringField("Effacer cet utilisateur")
